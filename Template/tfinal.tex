...
\input{config/preambulo_UNSJ.tex}
% Otros paquetes útiles 
\input{config/preambulo_otros.tex}

% Separación en sílabas arbitraria
\input{config/silabas.tex}%
...
% Versión 1
\input{secciones/pagtitulo_v1.tex} % Versión 1
% Versión 2
\input{secciones/pagtitulo_v2.tex} % Versión 2
...
\input{secciones/capitulo1.tex}
\input{secciones/capitulo2.tex}
\input{secciones/capitulo3.tex}
